...
namespace Web.Insfrastructure.Utilities.Filters
{
    public class UserActionFilter:ActionFilterAttribute
    {
        ...
        public UserActionFilter()
        {
            ...
            managePermission = new ManagePermission.ManagePermission(userPermission);
           
           
     
                if (!managePermission.CheckAction(action,controller))
                {
